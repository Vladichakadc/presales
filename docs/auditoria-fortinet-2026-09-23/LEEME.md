...
| N02 | nuevo | Medido: `LICENSES` venía de la lista de agosto y la fuente declarada es la de septiembre | 108 de 1.193 precios reanclados por SKU exacto. Los 17 que la lista vigente no trae se marcaban `anterior` y dejaban borrador; desde el 2026-09-24 (regla del dueño: los precios salen solo de la 2026Q3 Mid Price list) salen **sin precio**, marcados `fueraDeLista` | Cerrado | `test/fortinet-precios.test.js` N02 y «regla del dueño» |
...
| R9 | 17 líneas de renovación (70F, 100F, 200F, 600F) sin precio: la lista de septiembre no los trae en lo extraído | La línea sale sin precio, en borrador, y dice cuál; el precio de agosto ya no se usa | Un importador que extraiga esas filas de la misma lista por SKU exacto |
