...
document.addEventListener('DOMContentLoaded', () => {
  const st = ESTADO.vincular({ campos: ['bw','unit','head','chkVirtual','chkQos','chkBgp','bgpFeeds','chkPppoe','pppoeSess','chkCapsman','apCount','chkPoe','chkHa','mediaSeg','profileSeg','verdict-sel'] });
