...
const FUENTES = {
  fortinet: [
    { documento: 'Fortinet Product Matrix',
      ...
      fecha: '2026-09', hash: null, cubre: 'throughput por capa, sesiones, cps', campos: ['fw', 'vpn', 'ips', 'ngfw', 'tp', 'sess', 'cps', 'ifaces', 'redund'],
  ...
  juniper: [
    ...
    { documento: 'Hardware guides por modelo (SRX300/320/340/345/1500/1600/2300/4100/4200/4300/4700)',
      ...
      fecha: '2026-09-03', hash: null, cubre: 'alimentacion, redundancia de fuente y consumo medio de los 12 modelos SRX', campos: ['redund', 'psu'],
