...
const FUENTES = {
  fortinet: [
    ...
    { documento: 'Fichas por serie de FortiGate 100F y 200F, edicion coreana oficial (FG-100F-DAT-R30-20230227, FG-200F-DAT-R17-20230125)',
      ...
      cubre: 'sesiones nuevas/s, los siete limites de plataforma y la figura de hardware (frontal y trasera) de 100F y 200F',
      ...
      nota: 'Pendiente F6, cerrado el 2026-09-24. La ficha en INGLES da 404 en todas las rutas probadas (15 intentos en dos corridas de `traer-fortinet-pendientes.yml`); la COREANA oficial sigue en el CDN de fortinet.com, con la misma tabla y las etiquetas traducidas: los numeros no se traducen. Se reconstruyo la pagina 7 por coordenadas y se ANCLO con seis cifras ya verificadas por fila (fw, ips, ngfw, tp, vpn, sess): 12 de 12. Es una revision de 2023, anterior a la R42/R28 de 2025 de la que sale el consumo; el rendimiento casa en las seis anclas, el consumo del 100F NO (35,1 W frente a 26,5 W) y por eso el consumo sigue saliendo de la R42. La URL es la del 100F; la del 200F es la misma con `200f`. El dibujo del 100F rotula «FortiGate 212F» en el chasis, y se declara en su figura.' },
    { documento: 'Secure SD-WAN Ordering Guide (SDWAN-OG-R31-20260804)',
      ...
      cubre: 'el SKU del SD-WAN Service (bundle 1329/1337 y add-on 1387/1389) por modelo',
      campos: null, porQue: 'respalda un SKU comercial (`lic.sdwanSvc`), no un campo tecnico de MODELS',
      nota: 'Pendiente F2, cerrado el 2026-09-24 en lo que el documento resuelve. Los tres servicios avanzados (Underlay and Application Monitoring, Overlay Orchestration, conector FortiSASE) NO son tres lineas: son UN SKU por FortiGate. Se transcribio el add-on (1387 hasta el 50G, 1389 desde el 70G) de las tablas SERVICES de las paginas 3 a 6, con doble anclaje sobre el CODIGO DE MODELO contra la price list firmada: casan 20 de 23. En 70G, 200G y 4800F el documento imprime otro codigo que la price list y se quedan sin SKU con su motivo. La price list de septiembre no trae ninguno de estos SKU: la linea sale con SKU exacto y SIN precio, en borrador.' },
    { documento: 'FortiGate Subscriptions and FortiGuard Bundles Ordering Guide',
      ...
      nota: 'Traido el 2026-09-24. Su pagina 4 confirma que los tres servicios avanzados de SD-WAN llevan marca SOLO en la columna SD-WAN: ni a la carta ni dentro de Enterprise, UTP o ATP. Es la matriz de bundles que el informe de auditoria del 23-sep citaba como referencia [2] sin haberla podido leer.' },
