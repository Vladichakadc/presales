...
const FUENTES = {
  fortinet: [
    ...
    { documento: '2026Q3 Mid Price list_AMER_FINAL_EFF 090726.xlsx',
      url: null, fecha: '2026-09-07', hash: null, cubre: 'actualizacion de mitad de trimestre de la lista AMER — PENDIENTE de contrastar',
      nota: 'Cargada por el dueno del repo el 2026-09-08. Es un documento DISTINTO de la Main de agosto, no una version corregida: "Mid" es la actualizacion de mitad de trimestre del mismo 2026Q3, con fecha efectiva del 7 de septiembre. El sufijo EFF es MMDDYY y la lectura no se supuso: se comprobo contra la Main, cuyo EFF 080326 casa exactamente con el 2026-08-03 que este registro ya declaraba. '
        + 'NO SE HA TRANSFERIDO NI UN PRECIO DE ESTE DOCUMENTO: los `elp` del catalogo siguen saliendo de la Main, y por eso las dos entradas conviven. Registrar un documento dice que existe y de que fecha es; decir que los precios estan verificados contra el exigiria contrastarlo primero, y dar eso por hecho es la mentira que este catalogo tiene prohibida. Para contrastarlo: subirlo en «Fuentes y Referencias» abre la ventana de contraste, que desde el 2026-09-08 casa las listas de precios por SKU contra `hwSku` y dice que precios se movieron.' },
    { documento: '2026Q3 Main Price list_AMER_FINAL_EFF 080326.xlsx',
      url: null, fecha: '2026-08-03', hash: null, cubre: 'precios de hardware, licencias FortiGuard y soporte FortiCare — es de donde salen los `elp` vigentes',
      nota: 'Lista de precios AMER oficial, vigente desde el 3 de agosto de 2026. Es el unico fabricante de este catalogo con precios verificados contra una lista firmada, y sigue siendo la fuente de las cifras que el cotizador muestra hoy — la Mid del 7 de septiembre esta registrada pero todavia sin contrastar.' },
  ],
