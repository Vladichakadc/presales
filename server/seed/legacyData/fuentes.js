...
const FUENTES = {
  fortinet: [
    ...
    { documento: 'QuickStart Guide FortiGate 100F Series y FortiGate 200F Series',
      ...
      nota: 'Pendiente F6, cerrado el 2026-09-24 por otra sesion, que las leyo desde una maquina sin el proxy: p. 5 «Front/Rear - FG 100F Series» (el dibujo es un 101F, y el pie lo dice) y p. 6 «Front/Rear - FG 200F Series». La cara trasera es la de «Redundant Power Supplies», la misma ancla que los otros 54. Esa sesion no guardo la URL; estas son las del almacen de adjuntos de docs.fortinet.com, localizadas por su nombre de archivo (FG-100F-QSG.pdf y FG-200F-Series-QSG.pdf) y anadidas al transporte para contrastar pagina y rotulo contra una segunda copia. La URL es la del 100F; la del 200F es la adjunta 89694abf-1ef2-11eb-96b9-00505692583a. Sin fecha mientras no se lea la copia del transporte: una fuente sin fecha no se lee como reciente.' },
    ...
    { documento: '2026Q3 Mid Price list_AMER_FINAL_EFF 090726.xlsx',
      url: null, fecha: '2026-09-07', hash: null, cubre: 'precios de hardware, licencias FortiGuard, soporte FortiCare y SD-WAN Service', dominio: 'precio', campos: null,
