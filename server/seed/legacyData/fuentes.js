...
const FUENTES = {
  ...
  aruba: [
    ...
    { documento: 'Lista de precios de un distribuidor autorizado de HPE (export interno, no publico)',
      url: null, fecha: '2026-09-13', hash: null, cubre: 'List Price de HPE para 15 modelos EdgeConnect/gateway y 7 variantes de pedido TAA/NAL, las suscripciones EdgeConnect (Foundation/Advanced/On-Premises x 100M/1G/ilimitado x 1/3/5 anos), Boost SaaS y On-Premises, suscripciones Central de gateway 70xx/90xx, licencias perpetuas del 9240, unidades remanufacturadas 7000/7200 y los SKU de Foundational Care (NBD Exch y 4HR Onsite, 1/3/5 anos) de los 9 EdgeConnect',
      nota: 'Extracto elaborado por este catalogo el 2026-09-10 y ampliado el 2026-09-13 con las suscripciones, los remanufacturados, las variantes TAA/NAL y el Foundational Care por modelo (CARE_SKU en aruba.js): se guardo SOLO el SKU, la descripcion, el List Price y su vigencia (public/datasheets/aruba-lista-precios-hpe.csv); el nombre del distribuidor y su % de descuento negociado NO se incorporan, por ser su dato confidencial. Es precio de lista, no neto -- no reemplaza confirmar con el distribuidor antes de cotizar en firme. La correspondencia SKU<->descripcion de las suscripciones se verifico el 2026-09-13 contra el QuickSpecs oficial EdgeConnect SD-WAN (v18) publicado en hpe.com, y JZ118AAE contra una tienda publica (LIST $1,260.00, identico). Senal CONFIRMADA el 2026-09-13: EC-XL (SKU S0B67A) aparecia con estado "End of Sale" vigencia 2026-06-30 en su fila sin sufijo de pais y "GA" en las localizadas; la variante NAL (S3N77A) vino ya con PLC "ES" en este mismo export, y la Product Lifecycle Policy oficial de EdgeConnect (arubanetworking.hpe.com, techdocs) confirma "EC-XL-H end of sale announcement June 2025" (fecha de fin de venta 2025-09-30 segun el ciclo publicado). PENDIENTE decision del duenyo: marcar el modelo con eolAnnounced lastOrder 2025-09-30 (patron ya usado en Cisco) para que deje de salir recomendado en disenyos nuevos -- con el matiz de que hoy es el unico candidato por encima de 5 Gbps y excluirlo dejaria esos escenarios sin propuesta (ver el comentario junto a EC-XL en MODELS).' },
  ],
