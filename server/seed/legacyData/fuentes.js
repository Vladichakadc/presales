...
const FUENTES = {
  ...
  aruba: [
    { documento: 'Paginas de producto y tienda oficiales de HPE/Aruba',
      ...
      nota: 'SIN FECHA en la cabecera del catalogo. Los PDF no pudieron abrirse (bloqueo de egreso a los dominios de HPE): las cifras salen de las descripciones publicadas en esas paginas, no de la lectura integra del datasheet. Lo que sigue sin precio verificado (Foundational Care por variante de hardware, EC-V, EC-XS-SP, Dynamic Threat Defense) va en null y el BOM lo declara en "consultar".' },
    { documento: 'Lista de precios de un distribuidor autorizado de HPE (export interno, no publico)',
      url: null, fecha: '2026-09-13', hash: null, cubre: 'List Price de HPE para 15 modelos EdgeConnect/gateway, las suscripciones EdgeConnect (Foundation/Advanced/On-Premises x 100M/1G/ilimitado x 1/3/5 anos), Boost SaaS y On-Premises, suscripciones Central de gateway 70xx/90xx, licencias perpetuas del 9240 y unidades remanufacturadas 7000/7200',
      nota: 'Extracto elaborado por este catalogo el 2026-09-10 y ampliado el 2026-09-13 con las suscripciones y los remanufacturados: se guardo SOLO el SKU, la descripcion, el List Price y su vigencia (public/datasheets/aruba-lista-precios-hpe.csv); el nombre del distribuidor y su % de descuento negociado NO se incorporan, por ser su dato confidencial. Es precio de lista, no neto -- no reemplaza confirmar con el distribuidor antes de cotizar en firme. La correspondencia SKU<->descripcion de las suscripciones se verifico el 2026-09-13 contra el QuickSpecs oficial EdgeConnect SD-WAN (v18) publicado en hpe.com, y JZ118AAE contra una tienda publica (LIST $1,260.00, identico). Senal sin confirmar detectada en el mismo export: EC-XL (SKU S0B67A) aparece con estado "End of Sale" vigencia 2026-06-30 en su fila sin sufijo de pais, pero "GA" en todas sus variantes localizadas -- no se marca como descontinuado hasta confirmarlo (ver el comentario junto a EC-XL en MODELS).' },
  ],
