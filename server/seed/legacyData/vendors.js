// Copiado de index.html VENDORS (colores) — usado para poblar la tabla Vendor
module.exports = [
  { code: 'huawei', name: 'Huawei', colorHex: '#C7000B' },
  { code: 'cisco', name: 'Cisco', colorHex: '#049FD9' },
  { code: 'nokia', name: 'Nokia', colorHex: '#124191' },
