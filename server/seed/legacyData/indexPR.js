...
aruba:[
  ...
  {model:'EC-XL',ser:'EdgeConnect',seg:'Datacenter / Head-end de fabric',fwd:10000,ipsec:0,sdwan:'Foundation/Advanced + Boost',ports:'hasta 6x SFP+ 10G y/o SFP28 25G · network memory en flash PCIe · PSU y almacenamiento redundantes',elp:'Consultar'},
  {model:'EC-V',ser:'EdgeConnect',seg:'Virtual / Cloud (VMware, KVM, Hyper-V, AWS, Azure)',fwd:0,ipsec:0,sdwan:'Foundation/Advanced + Boost',ports:'vNIC según hipervisor · dimensionado por vCPU y por el tier de licencia contratado',elp:'Consultar'},
  {model:'Gateway 9004',ser:'Serie 9000',seg:'Sucursal peq',fwd:4000,ipsec:0,sdwan:'Gateway · Serie 9000',ports:'4x GbE RJ45 · 2.048 clientes · 128 APs (AOS 10; 32 en AOS 8)',elp:'Consultar'},
  {model:'Gateway 9004-LTE',ser:'Serie 9000',seg:'Sucursal peq + LTE',fwd:4000,ipsec:0,sdwan:'Gateway · Serie 9000',ports:'4x GbE RJ45 + LTE integrado (uplink dedicado o redundante) · 2.048 clientes · 128 APs (AOS 10; 32 en AOS 8)',elp:'Consultar'},
  {model:'Gateway 9012',ser:'Serie 9000',seg:'Sucursal med / gde',fwd:6000,ipsec:0,sdwan:'Gateway · Serie 9000',ports:'12x GbE RJ45 (6x PoE+) · 2.048 clientes · 256 APs (AOS 10; 32 en AOS 8)',elp:'Consultar'},
  {model:'Gateway 9106',ser:'Serie 9100 Hybrid',seg:'Sucursal gde / Campus peq',fwd:0,ipsec:0,sdwan:'Gateway · Serie 9100 Hybrid',ports:'2x SFP+ 10GbE + 2x combo SFP/RJ45 1GbE + 2x RJ45 1GbE con PoE hasta 60W · 8.000 clientes · 2.000 APs',elp:'Consultar'},
  {model:'Gateway 9114',ser:'Serie 9100 Hybrid',seg:'Campus peq / Sucursal grande',fwd:0,ipsec:0,sdwan:'Gateway · Serie 9100 Hybrid',ports:'4x SFP+ 10GbE + 4x combo SFP/RJ45 1GbE + 1 slot de expansión · 10.000 clientes · 4.000 APs',elp:'Consultar'},
  {model:'Gateway 9240',ser:'Serie 9200',seg:'Campus / Hub regional',fwd:20000,ipsec:0,sdwan:'Gateway · Serie 9200',ports:'4x SFP28 + 1 slot de expansión · 1U rack · 32.000 clientes · 4.000 APs sin licencia (AOS 10; 16.000 / 512 en AOS 8)',elp:'Consultar'},
  {model:'7005',ser:'Serie 7000',seg:'Sucursal peq (fanless)',fwd:2000,ipsec:0,sdwan:'Gateway · Serie 7000',ports:'4x RJ45 10/100/1000 · sin ventilador · alimentable por PoE · 1.024 clientes · 16 APs',elp:'Consultar'},
  {model:'7008',ser:'Serie 7000',seg:'Sucursal peq + PoE',fwd:2000,ipsec:0,sdwan:'Gateway · Serie 7000',ports:'8x RJ45 10/100/1000 con PoE y PoE+ integrados · sin ventilador · 1.024 clientes · 16 APs',elp:'Consultar'},
  {model:'7010',ser:'Serie 7000',seg:'Sucursal med',fwd:4000,ipsec:0,sdwan:'Gateway · Serie 7000',ports:'16x RJ45 10/100/1000 + 2x SFP · 2.048 clientes · 32 APs',elp:'Consultar'},
  {model:'7024',ser:'Serie 7000',seg:'Sucursal med · acceso unificado 24p',fwd:4000,ipsec:0,sdwan:'Gateway · Serie 7000',ports:'24x RJ45 10/100/1000 + 2x SFP+ 10G · 2.048 clientes · 32 APs',elp:'Consultar'},
  {model:'7030',ser:'Serie 7000',seg:'Sucursal gde',fwd:8000,ipsec:0,sdwan:'Gateway · Serie 7000',ports:'8x RJ45 10/100/1000 (combo) + puertos 10G · 4.096 clientes · 64 APs',elp:'Consultar'},
  {model:'7205',ser:'Serie 7200',seg:'Campus med',fwd:15000,ipsec:0,sdwan:'Gateway · Serie 7200',ports:'2x 10GBASE-X (SFP+) + 4x dual-media (1000BASE-X o 10/100/1000BASE-T) · 8.000 clientes · 256 APs',elp:'Consultar'},
  {model:'7210',ser:'Serie 7200',seg:'Campus gde',fwd:20000,ipsec:0,sdwan:'Gateway · Serie 7200',ports:'4x 10GBASE-X (SFP+) · 16.000 clientes · 512 APs',elp:'Consultar'},
  {model:'7220',ser:'Serie 7200',seg:'Campus grande / alta densidad',fwd:40000,ipsec:0,sdwan:'Gateway · Serie 7200',ports:'4x 10GBASE-X (SFP+) · 24.000 clientes · 1.024 APs',elp:'Consultar'},
  {model:'7240XM',ser:'Serie 7200',seg:'Campus máxima escala',fwd:40000,ipsec:0,sdwan:'Gateway · Serie 7200',ports:'4x 10GBASE-X (SFP+) · 32.000 clientes · 2.048 APs',elp:'Consultar'},
]
};
